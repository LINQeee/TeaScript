class WW {
    static #defaultSettings = {
        ...
        gradientStep: 100,
        gravity: 9.8,
        gameScreenWidth: () => window.mobileCheck() ? window.screen.width : window.innerWidth,
        gameScreenHeight: () => window.mobileCheck() ? window.screen.height : window.innerHeight
    };
    ...
    static #updateObject = (object) => {
        ...
        if (object.settings.hasCollision && object.settings.shouldMove && object.triggers && object.triggers.length)
    ...
    static #checkIfCollides = (object) => {
        ...
        object.stoppedTriggers = stoppedTriggers;
        object.newtriggers = newTriggers;
    ...
    static #updateSceneSize = () =>
        Object.values(this.layers).forEach((layer) => {
            layer.canvas.setAttribute("width", this.settings.gameScreenWidth().toString());
            layer.canvas.setAttribute("height", this.settings.gameScreenHeight().toString());
        });
